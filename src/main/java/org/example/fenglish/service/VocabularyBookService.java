...
public interface VocabularyBookService {
    // 1. 新增单词书
    void addVocabularyBook(VocabularyBookAddReq req);

    // 2. 删除单词书（含关联记录）
    void deleteVocabularyBook(String bookId);

    // 3. 修改单词书（仅修改名称、发布时间）
    void updateVocabularyBook(String bookId, VocabularyBookUpdateReq req);
